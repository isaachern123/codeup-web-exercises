 ...
 */
                    ...
                    //
                    //         } else if (luckyNumber === 1) {
                    //             return alert('your total is ' + (Total - (.10 * Total)))
                    //
                    //         } else if (luckyNumber === 2) {
                    //             return alert('your total is ' + (Total - (.25 * Total)))
                    //
                    //         } else if (luckyNumber === 3) {
                    //             return alert('your total is ' + (Total - (.35 * Total)))
                    //
                    //         } else if (luckyNumber === 4) {
                    //             return alert('your total is ' + (Total - (.50 * Total)))
                    //
                    //         } else if (luckyNumber === 5) {
                    //             return alert("Everything is Free!!!");
                    //         }
                    //     }
